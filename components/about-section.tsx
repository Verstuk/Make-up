        ...
        >
          ...
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground">
              Профессиональный визажист с более чем 5-летним опытом работы. Живу и работаю в основном в прекрасном городе Санкт-Петербург, но бывают выезды в другие города и страны.
            </p>
